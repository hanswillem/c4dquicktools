...
def main():
    renderPath = '/Volumes/ProjectDrobo/projecten lopend/NOM/Scripts/testFolder/'
    c4dFilePath = '/Volumes/ProjectDrobo/projecten lopend/NOM/Scripts/testFolder/'
    ...
    if len(layers) < 1:
        ...
        for i in layers:
            ...
            c4d.EventAdd()
            rd[c4d.RDATA_PATH] = renderPath + str(cnt) + '_' + i.GetName()
            #turn on alpha
            ...
            #save the document
            outputFile = c4dFilePath + str(cnt) + '_' + i.GetName()
